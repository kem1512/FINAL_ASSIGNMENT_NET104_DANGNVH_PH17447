...
using EF_DATABASE_FIRST_FINAL_ASSIGNMENT.DomainClass;

#nullable disable

namespace EF_DATABASE_FIRST_FINAL_ASSIGNMENT.Context
{
    public partial class FpolyDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=.\\sqlexpress;Initial Catalog=FINALASS_FPOLYSHOP_SM22_BL2_DUNGNA29;User ID=dangnvhph17447;Password=badao1234");
            }
        }
